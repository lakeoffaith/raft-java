...
import com.github.wenweihu86.raft.proto.RaftConsensusServiceGrpc.RaftConsensusServiceImplBase;
 ...
 */
public class RaftConsensusServiceImpl extends RaftConsensusServiceImplBase {

    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(RaftConsensusServiceImpl.class);
    ...
    @Override
    public void hello(RaftProto.VoteRequest request,StreamObserver<RaftProto.VoteResponse> responseObserver) {
        //打印输出
        ...
        VoteResponse reply= responseBuilder.build();
    ...
    // @Override
    // public void preVote(RaftProto.VoteRequest request,StreamObserver<RaftProto.VoteResponse> responseObserver) {
